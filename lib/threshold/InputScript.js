 ...
 * @param {Buffer} data.message - In format of CashScript PriceOracle - includes valid blockheight (https://github.com/Bitcoin-com/cashscript/blob/master/examples/PriceOracle.ts)
